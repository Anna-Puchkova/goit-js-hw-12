import{a as w,S,i as n}from"./assets/vendor-DQvd0HNi.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function r(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(e){if(e.ep)return;e.ep=!0;const s=r(e);fetch(e.href,s)}})();const P="55034469-fe8c7c81350cc4405e2a2064a",f=15;async function m(t,a){const r={key:P,q:t,image_type:"photo",orientation:"horizontal",safesearch:!0,page:a,per_page:f};return(await w.get("https://pixabay.com/api/",{params:r})).data}const y=document.querySelector(".gallery"),h=new S(".gallery a",{captionsData:"alt",captionDelay:250});h.refresh();function g(t){const r=t.map(o=>`
